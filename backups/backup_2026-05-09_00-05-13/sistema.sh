...
tarea_backup() {
  ...
  # Buscamos archivos .sh recursivamente para que encuentre los de la carpeta scripts/
  find "$DIR_ORIGEN" -name "*.sh" -exec cp {} "$destino/" \; 2>/dev/null || true
